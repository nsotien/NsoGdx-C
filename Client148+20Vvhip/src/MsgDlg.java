public final class MsgDlg extends Dialog {
   ...
   public final void gameAB() {
      this.gameAA(mResources.gameBG, (Command)null, (Command)null, (Command)null);
   ...
   public final void gameAA(mGraphics var1) {
      ...
      if (this.isWait) {
         var2 += 8;
         GameCanvas.gameAA(GameCanvas.hw, var2 - 12, var1);
      }

      for(int var3 = 0; var3 < this.info.length; var2 += mFont.tahoma_8b.gameAC()) {
