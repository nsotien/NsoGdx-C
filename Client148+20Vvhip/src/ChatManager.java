public final class ChatManager {
   ...
   public ChatManager() {
      ...
      ChatTab var1;
      (var1 = this.gameAA(mResources.GLOBALCHAT[0])).gameAA("c8" + mResources.GLOBALCHAT[1]);
      var1.gameAA("c8" + mResources.GLOBALCHAT[2]);
      var1.gameAA("c8" + mResources.GLOBALCHAT[3]);
      this.gameAA(mResources.PARTYCHAT[0]).gameAA("c8" + mResources.PARTYCHAT[1]);
      this.gameAA(mResources.CLANCHAT[0]).gameAA("c8" + mResources.CLANCHAT[1]);
      this.gameAA(mResources.PUBLICCHAT[0]).gameAA("c8" + mResources.PUBLICCHAT[1]);
   }
   ...
   public final ChatTab gameAB(String var1) {
      ...
      if (!GameCanvas.isTouch) {
         var2.gameAA("c2" + mResources.CLOSE_CURTAB);
      }
