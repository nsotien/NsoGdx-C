public final class LanguageScr extends mScreen implements IActionListener {
   ...
   public final void gameAA(mGraphics var1) {
      ...
      var1.gameAB(GameCanvas.hw - mFont.tahoma_8b.gameAA(mResources.LANGUAGE) / 2 - 12, this.popupY + 7, mFont.tahoma_8b.gameAA(mResources.LANGUAGE) + 22, 24, 6, 6);
      var1.gameAA(Paint.COLORLIGHT);
      var1.gameAA(GameCanvas.hw - mFont.tahoma_8b.gameAA(mResources.LANGUAGE) / 2 - 12, this.popupY + 7, mFont.tahoma_8b.gameAA(mResources.LANGUAGE) + 22, 24, 6, 6);
      mFont.tahoma_8b.gameAA(var1, mResources.LANGUAGE, GameCanvas.hw, this.popupY + 12, 2);
      String[] var2 = mResources.LANGUAGES;
      int var3 = this.popupY + 50;

      for(int var4 = 0; var4 < var2.length; ++var4) {
         var1.gameAA(Paint.COLORDARK);
         var1.gameAD(this.popupX + 10, var3 + var4 * 35, this.popupW - 20, 28);
         var1.gameAA(5720393);
