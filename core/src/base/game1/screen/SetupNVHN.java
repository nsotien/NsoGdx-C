...
public class SetupNVHN implements ScreenChild {
    ...
    public SetupNVHN() {
        ...
        build();
        if (DebugLog.DEBUG) DebugLog.log("UI", "SetupNVHN created");
    }
    ...
    private void saveSettings() {
        try {
            ...
            if (DebugLog.DEBUG) DebugLog.log("UI", "SetupNVHN saved " + data);
        } catch (Exception e) {
            Code.popup_chat("Lỗi: kiểm tra lại cài đặt!");
            if (DebugLog.DEBUG) DebugLog.error("SetupNVHN save failed: " + e.getMessage(), e);
        }
    }
    ...
    @Override public void resize(int w, int h) {
        ...
        UIKit.layoutPanel(stage, panel);
        UIKit.logResize("SetupNVHN", stage, w, h);
    }
