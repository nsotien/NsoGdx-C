...
public class ScreenMobIDFilter implements ScreenChild {
    ...
    public ScreenMobIDFilter() {
        ...
        build();
        if (DebugLog.DEBUG) DebugLog.log("UI", "ScreenMobIDFilter created");
    }
    ...
    private void save() {
        ...
        if (DebugLog.DEBUG) DebugLog.log("UI", "ScreenMobIDFilter saved bat=" + Code.danhTheoID + " ids=" + s);
    }

    @Override public void resize(int w, int h) {
        stage.getViewport().update(w, h, true);
        UIKit.layoutPanel(stage, panel);
        UIKit.logResize("ScreenMobIDFilter", stage, w, h);
    }
