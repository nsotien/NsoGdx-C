...
public class ScreenAutoOnOff implements ScreenChild {
    ...
    public ScreenAutoOnOff() {
        ...
        build();
        if (DebugLog.DEBUG) DebugLog.log("UI", "ScreenAutoOnOff created");
    }
    ...
    private void save() {
        ...
        Code.popup_chat("Auto On-Off: " + (Code.autoOnOff
                ...
                : "Tắt"));
        if (DebugLog.DEBUG) DebugLog.log("UI", "ScreenAutoOnOff saved bat=" + Code.autoOnOff + " off=" + Code.onoffOffHour + ":" + Code.onoffOffMin + " on=" + Code.onoffOnHour + ":" + Code.onoffOnMin);
    }

    @Override public void resize(int w, int h) {
        stage.getViewport().update(w, h, true);
        UIKit.layoutPanel(stage, panel);
        UIKit.logResize("ScreenAutoOnOff", stage, w, h);
    }
