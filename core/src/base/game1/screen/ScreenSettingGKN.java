...
public class ScreenSettingGKN implements ScreenChild {
    ...
    public ScreenSettingGKN() {
        ...
        build();
        if (DebugLog.DEBUG) DebugLog.log("UI", "ScreenSettingGKN created");
    }
    ...
    private void save() {
        ...
        if (DebugLog.DEBUG) DebugLog.log("UI", "ScreenSettingGKN saved bat=" + Code.giuKetNoi + " mode=" + Code.giuKetNoiMode);
    }

    @Override public void resize(int w, int h) {
        stage.getViewport().update(w, h, true);
        UIKit.layoutPanel(stage, panel);
        UIKit.logResize("ScreenSettingGKN", stage, w, h);
    }
