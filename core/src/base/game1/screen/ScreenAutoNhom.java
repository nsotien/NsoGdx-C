...
import base.game1.Char;
import base.game1.Code;
import base.game1.DebugLog;
import base.game1.MyVector;
...
public final class ScreenAutoNhom implements ScreenChild {
    ...
    private ScreenAutoNhom() {
        ...
        build();
        if (DebugLog.DEBUG) DebugLog.log("UI", "ScreenAutoNhom created");
    }
    ...
    private void save() {
        ...
        if (newRole == 0) {
            ...
            if (my == null || my.cName == null) {
                ...
                if (DebugLog.DEBUG) DebugLog.log("UI", "ScreenAutoNhom save blocked: myChar null");
                return;
            }
        ...
        if (DebugLog.DEBUG) DebugLog.log("UI", "ScreenAutoNhom save on=" + Code.autoPtOn
                + " role=" + Code.autoPtRole + " ig_lead=" + Code.ig_lead);
    ...
    @Override public void resize(int w, int h) {
        ...
        UIKit.layoutPanel(stage, panel);
        UIKit.logResize("ScreenAutoNhom", stage, w, h);
    }
