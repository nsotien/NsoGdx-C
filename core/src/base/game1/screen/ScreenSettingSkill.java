...
public class ScreenSettingSkill implements ScreenChild {
    ...
    public ScreenSettingSkill() {
        ...
        build();
        if (DebugLog.DEBUG) DebugLog.log("UI", "ScreenSettingSkill created");
    }
    ...
    private void saveFromUI() {
        ...
        if (DebugLog.DEBUG) DebugLog.log("UI", "ScreenSettingSkill saved ids=" + skillIds[0] + "," + skillIds[1]
                + "," + skillIds[2] + "," + skillIds[3] + "," + skillIds[4]);
    }
    ...
    @Override public void resize(int w, int h) {
        ...
        UIKit.layoutPanel(stage, panel);
        UIKit.logResize("ScreenSettingSkill", stage, w, h);
    }
