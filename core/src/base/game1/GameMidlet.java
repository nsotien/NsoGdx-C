    ...
    public GameMidlet(int ver) {
        try {
            ...
            if (!GameCanvas.m) {
                ...
                gameAC();
                // [SLEEP-INFO] Register provider cho tab 1 — SleepManager gọi lấy snapshot khi ngủ
                com.monkey.nso.SleepManager.registerProvider(1, new SleepInfoProvider());
                DebugLog.log("GameMidlet", "Init complete + SleepInfoProvider tab=1 registered");
            }
            startApp();
        } catch (Exception e) {
