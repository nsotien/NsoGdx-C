...
public class phong2 {
   ...
   // [SIZE-PC] Size cua so PC — luu/doc o cwd. Pending: preset user vua click, show khi confirm dialog
   ...
   // [SIZE-PC] Ghi file pcWindowSize.txt o cwd. Format "WxH"
   ...
   // [SIZE-PC] Doc label size hien tai tu file de show tren nut menu
   ...
   private static void handlePcSizePick(int w, int h) {
      // Lop 2: guard trong handler — no-op tren mobile
      if (Gdx.app == null || Gdx.app.getType() != Application.ApplicationType.Desktop) {
         if (DebugLog.DEBUG) ;
         return;
      }
      ...
      // Dialog voi 2 button dung ANONYMOUS LISTENER inline → bypass tat ca switch case dispatch.
      // Command1.a() goi listener.a(cmd, obj) truc tiep — khong qua GameScr.b hay GameCanvas.a switch.
      ...
      // FIX overlap: MsgDlg.a set 2 button qua gan (aa/2-80 va aa/2+10, cach 90px),
      // button width = 70*zoom (vd zoom=3 → 210px) → overlap ~120px → LEFT luon win.
      // Override position: day 2 button ra 2 canh man hinh, khong the overlap.
      closeBtn.f = 5;
   ...
   public static void menu_vip() {
      // P2 A1#9: g9 cross-check khi mo menu vip — fail thi return menu trong (click khong action).
   ...
   public boolean game_perform(int num_case, Object obj) {
      ...
      switch (num_case) {
         ...
         case 1370:
            ...
            return true;
         case 1371:
            ScreenManager.showOnGL(new Runnable() { public void run() { ScreenManager.show(new base.game1.screen.SetupDapDo()); } });
            return true;
         case 137:
            ...
            return true;
         case 138:
            ScreenManager.showOnGL(new Runnable() { public void run() { ScreenManager.show(base.game1.screen.ListKO.gI()); } });
            return true;
         case 139:
            ScreenManager.showOnGL(new Runnable() { public void run() { ScreenManager.show(base.game1.screen.ListPK.gI()); } });
            return true;
         case 140:
            ScreenManager.showOnGL(new Runnable() { public void run() { ScreenManager.show(base.game1.screen.ListBlock.gI()); } });
            return true;
         case 141:
            ScreenManager.showOnGL(new Runnable() { public void run() { ScreenManager.show(base.game1.screen.ListGroup.gI()); } });
            return true;
         case 143:
         ...
         case 149:
            ...
            // [UX-PREFILL] show gia tri hien tai
         ...
         case 1600:
            ...
            // [SIZE-PC/UX] prefill gia tri hien tai → user thay de sua hoac xoa
         ...
         case 16001:
            try {
               ...
               if (slpMin >= 1) {
                  ...
                  Code.popup_chat("Time Sleep: " + slpMin + "phút");
                  ;
               } else {
         ...
         case 1805:
            ScreenManager.showOnGL(new Runnable() { public void run() {
               if (ScreenManager.screenAutoMuaItem == null) ScreenManager.screenAutoMuaItem = new base.game1.screen.ScreenAutoMuaItem();
               ScreenManager.show(ScreenManager.screenAutoMuaItem);
            } });
            return true;
         case 1806:
            ScreenManager.showOnGL(new Runnable() { public void run() {
               if (ScreenManager.screenAutoNPC == null) ScreenManager.screenAutoNPC = new base.game1.screen.ScreenAutoNPC();
               ScreenManager.show(ScreenManager.screenAutoNPC);
            } });
            return true;
         case 1807:
            ScreenManager.showOnGL(new Runnable() { public void run() {
               if (ScreenManager.screenAutoOnOff == null) ScreenManager.screenAutoOnOff = new base.game1.screen.ScreenAutoOnOff();
         ...
         case 1802:
            ScreenManager.showOnGL(new Runnable() {
               public void run() {
                  ScreenManager.show(new base.game1.screen.ScreenMobIDFilter());
               }
            });
            return true;
         case 1804:
         ...
         case 1808:
            ...
            ScreenManager.showOnGL(new Runnable() {
               public void run() {
                  ScreenManager.show(base.game1.screen.ScreenAutoNhom.gI());
               }
            });
            return true;
         case 1809:
            ...
            ScreenManager.showOnGL(new Runnable() {
               public void run() {
                  ScreenManager.show(new base.game1.screen.ScreenCaiGom());
               }
            });
            return true;
         case 1803:
   ...
   static {
      ...
      // [SIZE-PC] load label hien tai tu file de show tren nut menu
