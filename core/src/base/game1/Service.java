...
public final class Service {
   ...
   public final void login(String var1, String var2, String var3) {
      ...
      // Neu isVerified=true ma verifyStarted=false -> cracker patched decoy.
      ...
      // P2 A1#1: g1 cross-check truoc login. Fail -> delay 45-75s roi return KHONG login (khong crash).
