...
public final class FormDanhVong extends Form implements CommandListener {
   ...
   private FormDanhVong() {
      ...
      this.append(this.advBA = new ChoiceGroup("Tu di lam DV?", 1, new String[]{"Bat", "Tat"}, (Image[]) null));
      ...
      this.append(this.advBJ = new TextField("Map loi dai: ", String.valueOf(advAC), 3, 2));
      this.append(this.advBK = new TextField("Khu loi dai: ", String.valueOf(advAD), 3, 2));
