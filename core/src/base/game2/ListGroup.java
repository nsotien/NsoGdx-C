...
public final class ListGroup implements CommandListener {
   private Command a;
   private Command b;
   private Command c;
   private Command d;
   ...
   public static ListGroup abc = new ListGroup();

   public static ListGroup gI() {
      if (abc == null) {
         abc = new ListGroup();
      }
   ...
   public final void a() {
      if (k.size() <= 0) {
         this.h = new Form("Danh sách ưu tiên");
         this.h.append("Họ có thể tỉ thí, mời nhóm, hay giao dịch được với bạn");
         ...
         this.f = new List("Danh sách ưu tiên", 3);
   ...
   public final void commandAction(Command var1, Displayable var2) {
      ...
      if (var1 == this.b) {
         this.g = new Form("Thêm ingame ưu tiên");
   ...
   private static void a(int var0, String var1) {
      try {
         ...
         int var3;
         byte[] var6;
         if ((var3 = (var2 = RecordStore.openRecordStore("grList", true)).getNumRecords()) <= 0) {
            var6 = new byte[0];
   ...
   private static String b(int var0, String var1) {
      try {
         byte[] var3 = RecordStore.openRecordStore("grList", true).getRecord(1);
   ...
   public static boolean a(String var0) {
      return base.game2.screen.ListGroup.a(var0);
   }
