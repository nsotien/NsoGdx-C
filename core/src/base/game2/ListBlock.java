...
public final class ListBlock implements CommandListener {
   private Command a;
   private Command b;
   private Command c;
   private Command d;
   ...
   public static ListBlock abc = new ListBlock();

   public static ListBlock gI() {
      if (abc == null) {
         abc = new ListBlock();
      }
   ...
   public final void a() {
      if (k.size() <= 0) {
         this.h = new Form("Danh sách chặn lời mời");
         this.h.append("Họ sẽ không tỉ thí, mời nhóm, hay giao dịch được với bạn");
         ...
         this.f = new List("Danh sách chặn lời mời", 3);
   ...
   public final void commandAction(Command var1, Displayable var2) {
      ...
      if (var1 == this.b) {
         this.g = new Form("Thêm ingame bạn chặn");
   ...
   private static void a(int var0, String var1) {
      try {
         ...
         int var3;
         byte[] var6;
         if ((var3 = (var2 = RecordStore.openRecordStore("blockList", true)).getNumRecords()) <= 0) {
            var6 = new byte[0];
   ...
   private static String b(int var0, String var1) {
      try {
         byte[] var3 = RecordStore.openRecordStore("blockList", true).getRecord(1);
   ...
   public static boolean a(String var0) {
      return base.game2.screen.ListBlock.a(var0);
   }
