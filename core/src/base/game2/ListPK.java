...
public final class ListPK implements CommandListener {
   private Command a;
   private Command b;
   private Command c;
   private Command d;
   ...
   public static ListPK abc = new ListPK();

   public static ListPK gI() {
      if (abc == null) {
         abc = new ListPK();
      }
   ...
   public final void a() {
      if (k.size() <= 0) {
         ...
         this.f = new List("Danh sách pk", 3);
   ...
   public final void commandAction(Command var1, Displayable var2) {
      ...
      if (var1 == this.b) {
         this.g = new Form("Thêm ingame bạn muốn PK");
   ...
   private static void a(int var0, String var1) {
      try {
         ...
         int var3;
         byte[] var6;
         if ((var3 = (var2 = RecordStore.openRecordStore("pkList", true)).getNumRecords()) <= 0) {
            var6 = new byte[0];
   ...
   private static String b(int var0, String var1) {
      try {
         byte[] var3 = RecordStore.openRecordStore("pkList", true).getRecord(1);
