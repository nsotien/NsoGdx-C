...
public final class SmallImage {
   ...
   public static void gameAC() {
      ...
      System.gc();
      imgbig = new Image[]{
         GameCanvas.loadImage("/img/Big0.png"),
         GameCanvas.loadImage("/img/Big1.png"),
         GameCanvas.loadImage("/img/Big2.png"),
         GameCanvas.loadImage("/img/Big3.png"),
         GameCanvas.loadImage("/img/Big4.png")
      };
   ...
   public static boolean gameAA(int var0) {
      if (var0 >= smallImg.length
         || smallImg[var0][1] >= imgbig[smallImg[var0][0]].getWidth()
         || smallImg[var0][3] >= imgbig[smallImg[var0][0]].getWidth()
         || smallImg[var0][2] >= imgbig[smallImg[var0][0]].getHeight()
         || smallImg[var0][4] >= imgbig[smallImg[var0][0]].getHeight()) {
         MyImage var1;
   ...
   public static void gameAA(mGraphics var0, int var1, int var2, int var3, int var4, int var5) {
      if (var1 < smallImg.length
         && smallImg[var1][1] < imgbig[smallImg[var1][0]].getWidth()
         && smallImg[var1][3] < imgbig[smallImg[var1][0]].getWidth()
         && smallImg[var1][2] < imgbig[smallImg[var1][0]].getHeight()
         && smallImg[var1][4] < imgbig[smallImg[var1][0]].getHeight()) {
   ...
   public static void gameAAA(mGraphics var0, int var1, int var2, int var3, int var4, int var5) {
      try {
         ...
         if ((var10 = (MyImage)imgNew.get("" + var1)) == null) {
            ...
            var8.img = GameCanvas.loadImage(var7);
            var10.img = var8.img;
            if (var10.img == null) {
