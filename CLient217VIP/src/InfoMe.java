   ...
   private static boolean gameAB(String var0) {
      if (info != null && info.s != null && var0.equals(info.s)) {
         ...
         if (info != null && info.s != null && p1 < 3 && info.s.length() >= 8) {
            ...
            String var2 = info.s.substring(0, 8);
            if (var1.equals(var2)) {
               int var5 = 7;
               ...
               while (
                  var5 < var0.length()
                     && var5 < info.s.length()
                     && (var0.charAt(var5) < '0' || var0.charAt(var5) > '9')
                     && var0.charAt(var5) == info.s.charAt(var5)
               ) {
                  var5++;
               }
         ...
         if (infoWaitToShow.size() > 0 && (var1 = ((InfoItem)infoWaitToShow.lastElement()).s).length() >= 8) {
            String var2 = var0.substring(0, 8);
            ...
            if (var2.equals(var3)) {
               ...
               while (
                  var4 < var0.length()
                     && var4 < var1.length()
                     && (var0.charAt(var4) < '0' || var0.charAt(var4) > '9')
                     && var0.charAt(var4) == var1.charAt(var4)
               ) {
                  var4++;
               }
