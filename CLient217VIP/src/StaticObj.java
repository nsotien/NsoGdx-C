public final class StaticObj {
   ...
   public static final int[][] TYPEBG = new int[][]{
      new int[4],
      {1, 1, 1, 1},
      new int[4],
      {2, 2, 2, 2},
   ...
   public static final int[] SKYCOLOR = new int[]{
      5614318, 4751608, 1052688, 2081781, 2081781, 3248838, 10541304, 2526662, 1513480, 16760764, 1285290, 1285290, 1285290, 4882101, 4882101, 3018762, 4352644
   };
}
