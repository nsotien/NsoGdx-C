...
public final class Session_ME {
   ...
   public final void gameAA11(String var1, int var2) {
      String var3 = new String(new char[] { 's', 'o', 'c', 'k', 'e', 't', ':', '/', '/' }) + var1
            + new String(new char[] { ':' }) + var2;
      if (GameCanvas.gameCE) {
         if (!GameCanvas.isGPRS) {
            var3 = var3 + new String(
                  new char[] { ';', 'i', 'n', 't', 'e', 'r', 'f', 'a', 'c', 'e', '=', 'w', 'i', 'f', 'i' });
         } else {
            var3 = var3 + new String(
                  new char[] { ';', 'd', 'e', 'v', 'i', 'c', 'e', 's', 'i', 'd', 'e', '=', 't', 'r', 'u', 'e' });
         }
      }
