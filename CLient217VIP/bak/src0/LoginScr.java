...
public final class LoginScr extends mScreen implements IActionListener {
   ...
   public final void update() {
      ...
      if (!welcomeShown) {
         welcomeShown = true;
         GameCanvas.setText("Chào Mừng Bạn Tới Với Sever ĐẢO QUỐC NINJA");
      }
   }
   ...
   public final void paint(mGraphics var1) {
      ...
      if (GameCanvas.currentDialog == null) {
         ...
         if (GameCanvas.h > 160 && imgTitle != null) {
            ...
            (GameCanvas.gameTick % 10 > 5 ? mFont.tahoma_7b_yellow : mFont.tahoma_7b_white)
               .gameAA(var1, "Phiên bản được CƯƠNG SEX", GameCanvas.hw, var2 + 10, 2);
         }
         ...
         for (int var41 = 0; var41 < this.currentTip.length; var41++) {
            mFont.tahoma_7_white.gameAA(var1, this.currentTip[var41], GameCanvas.w / 2, this.tfUser.y - 15 + var41 * 10, 2, mFont.tahoma_7_grey);
         }
      }
      ...
      if (this.showWelcome) {
         ...
         mFont.tahoma_7b_yellow.gameAA(var1, "Chào Mừng Bạn Tới Với Sever ĐẢO QUỐC NINJA", GameCanvas.hw, GameCanvas.h - 78, 2);
   ...
   public final void perform(int var1, Object var2) {
      switch (var1) {
         ...
         case 1004:
            ...
            return;
         case 1005:
            GameCanvas.gameAA(mResources.gameDT, new Command("3G/Wifi", this, 3000, null), new Command("GPRS", this, 3001, null));
            return;
         case 1006:
            GameCanvas.gameAA(
               mResources.gameBG, new Command(mResources.gameEC, this, 10061, null), new Command(mResources.gameCU, GameCanvas.gameAA(), 8882, null)
            );
            return;
         case 1009:
            RMS.gameAA();
         ...
         case 20041:
            ...
            GameCanvas.gameAA(mResources.gameDU, new Command(mResources.gameCH, this, 200421, null), new Command(mResources.gameCU, this, 200422, null));
            return;
         case 20051:
            GameScr.gI().update();
            return;
