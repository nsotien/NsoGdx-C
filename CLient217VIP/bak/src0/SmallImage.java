...
public final class SmallImage {
   ...
   public static void gameAC() {
      ...
      System.gc();
      imgbig = new Image[]{
         GameCanvas.gameAC("/img/Big0.png"),
         GameCanvas.gameAC("/img/Big1.png"),
         GameCanvas.gameAC("/img/Big2.png"),
         GameCanvas.gameAC("/img/Big3.png"),
         GameCanvas.gameAC("/img/Big4.png")
      };
