...
public final class GameScr extends mScreen implements IActionListener, IChatable {
   ...
   public static Image gameEY = GameCanvas.gameAC("/hd/tf.png");
   public static Image gameEZ;
   public static Image imgLbtn;
   public static Image imgLbtnFocus;
   private static Image gameNS = GameCanvas.gameAC("/u/select.png");
   ...
   public static Image gameFR = GameCanvas.gameAC("/trung1.png");
   public static Image gameFS = GameCanvas.gameAC("/eff/g132.png");
   public static Image imgEffMob1 = GameCanvas.gameAC("/eff/g10.png");
   public static Image imgEffMob2 = GameCanvas.gameAC("/eff/g6.png");
   public static Image imgEffMob3 = GameCanvas.gameAC("/eff/g99.png");
   public static Image imgsmokeFollow = GameCanvas.gameAC("/eff/g9.png");
   ...
   public final void gameAD() {
      ...
      for (int var21 = 0; var21 < EffectAnimation.vEffect2.size(); var21++) {
         ((EffectAnimation)EffectAnimation.vEffect2.elementAt(var21)).update();
      }

      for (int var22 = 0; var22 < EffectAnimation.vEffect2Outside.size(); var22++) {
         ((EffectAnimation)EffectAnimation.vEffect2Outside.elementAt(var22)).update();
      }

      for (int var23 = 0; var23 < EffectAnimation.vAnimateEffect.size(); var23++) {
   ...
   public final void paint(mGraphics var1) {
      if (Char.ischangingMap) {
         ...
         if (!Char.getMyChar().isCaptcha) {
            ...
            (GameCanvas.gameTick % 10 > 5 ? mFont.tahoma_7b_yellow : mFont.tahoma_7b_white).gameAA(var1, " CƯƠNG SEX", GameCanvas.hw, 2, 2);
            ...
            if (!GameCanvas.isTouch || GameCanvas.isTouch && !GameCanvas.gameAH) {
               ...
               if (GameCanvas.gameTick % 20 < 10) {
                  mFont.tahoma_7b_yellow.gameAA(var1, "CƯƠNG SEX", GameCanvas.hw, 5, 2);
   ...
   private void gameAA(mGraphics var1, Item var2, int var3, int var4, int var5, int var6) {
      if (!var2.isTypeMounts()) {
         if ((var5 = var5 + var2.upgrade) > 0) {
            if (var5 >= 4 && var5 < 17) {
               var1.gameAA(this.gameTM[var5 >= this.gameTM.length ? this.gameTM.length - 1 : var5]);
               var1.gameAC(var3 + 1 + var6, var4 + 1 + var6, gameHK - 1 - var6 * 2, gameHK - 1 - var6 * 2);
            ...
            if (var5 >= 17) {
               Image[][] egItems = new Image[][]{
                  {
                        GameCanvas.bgitem6x1,
                        GameCanvas.bgitem6x2,
                        GameCanvas.bgitem6x3,
                        GameCanvas.bgitem6x4,
                        GameCanvas.bgitem6x5,
                        GameCanvas.bgitem6x6,
                        GameCanvas.bgitem6x7,
                        GameCanvas.bgitem6x8
                  },
                  {
                        GameCanvas.bgitem7x1,
                        GameCanvas.bgitem7x2,
                        GameCanvas.bgitem7x3,
                        GameCanvas.bgitem7x4,
                        GameCanvas.bgitem7x5,
                        GameCanvas.bgitem7x6,
                        GameCanvas.bgitem7x7,
                        GameCanvas.bgitem7x8
                  },
                  {
                        GameCanvas.bgitem8x1,
                        GameCanvas.bgitem8x2,
                        GameCanvas.bgitem8x3,
                        GameCanvas.bgitem8x4,
                        GameCanvas.bgitem8x5,
                        GameCanvas.bgitem8x6,
                        GameCanvas.bgitem8x7,
                        GameCanvas.bgitem8x8
                  },
                  {
                        GameCanvas.bgitem9x1,
                        GameCanvas.bgitem9x2,
                        GameCanvas.bgitem9x3,
                        GameCanvas.bgitem9x4,
                        GameCanvas.bgitem9x5,
                        GameCanvas.bgitem9x6,
                        GameCanvas.bgitem9x7,
                        GameCanvas.bgitem9x8
                  }
               };
               int effectType = var5 >= 20 ? 3 : var5 - 17;
               int currentFrame = GameCanvas.gameTick / 2 % 8;
               Image frame = egItems[effectType][currentFrame];
               if (frame != null) {
                  int iw = mGraphics.gameAA(frame);
                  int ih = mGraphics.gameAB(frame);
                  int sw = gameHK < iw ? gameHK : iw;
                  int sh = gameHK < ih ? gameHK : ih;
                  int sx = (iw - sw) / 2;
                  int sy = (ih - sh) / 2;
                  var1.gameAA(frame, sx, sy, sw, sh, 0, var3 + gameHK / 2, var4 + gameHK / 2, 3);
               }
            } else if (var5 >= 1) {
               ...
               GameScr var14 = this;
               int var9 = gameHK - 2;
               int var10 = var5 < 4 ? 0 : (var5 < 8 ? 1 : (var5 < 12 ? 2 : (var5 <= 14 ? 3 : 4)));

               for (int var11 = 0; var11 < var14.gameTO.length; var11++) {
                  int var12 = var18 - var9 / 2 + gameAJ(GameCanvas.gameTick - (var11 << 2));
                  int var13 = var6 - var9 / 2 + gameAI(GameCanvas.gameTick - (var11 << 2));
               ...
               if (var5 == 4 || var5 == 8) {
                  for (int var28 = 0; var28 < var14.gameTO.length; var28++) {
                     int var12 = var18 - var9 / 2 + gameAJ(GameCanvas.gameTick - (var9 << 1) - (var28 << 2));
                     int var13 = var6 - var9 / 2 + gameAI(GameCanvas.gameTick - (var9 << 1) - (var28 << 2));
                     var8.gameAA(var14.gameTN[var10 - 1][var28]);
                     var8.gameAC(var12 - var14.gameTO[var28] / 2, var13 - var14.gameTO[var28] / 2, var14.gameTO[var28], var14.gameTO[var28]);
                  }
               }

               if (var5 != 1 && var5 != 4 && var5 != 8) {
                  for (int var29 = 0; var29 < var14.gameTO.length; var29++) {
                     int var12 = var18 - var9 / 2 + gameAJ(GameCanvas.gameTick - (var9 << 1) - (var29 << 2));
                     int var13 = var6 - var9 / 2 + gameAI(GameCanvas.gameTick - (var9 << 1) - (var29 << 2));
                     var8.gameAA(var14.gameTN[var10][var29]);
                     var8.gameAC(var12 - var14.gameTO[var29] / 2, var13 - var14.gameTO[var29] / 2, var14.gameTO[var29], var14.gameTO[var29]);
                  }
               }

               if (var5 != 1 && var5 != 4 && var5 != 8 && var5 != 12 && var5 != 2 && var5 != 5 && var5 != 9) {
                  for (int var30 = 0; var30 < var14.gameTO.length; var30++) {
                     int var12 = var18 - var9 / 2 + gameAJ(GameCanvas.gameTick - var9 - (var30 << 2));
                     int var13 = var6 - var9 / 2 + gameAI(GameCanvas.gameTick - var9 - (var30 << 2));
                     var8.gameAA(var14.gameTN[var10][var30]);
                     var8.gameAC(var12 - var14.gameTO[var30] / 2, var13 - var14.gameTO[var30] / 2, var14.gameTO[var30], var14.gameTO[var30]);
                  }
               }
               ...
               if (var5 != 1
                  ...
                  && var5 != 10
                  && var5 != 15) {
                  for (int var31 = 0; var31 < var14.gameTO.length; var31++) {
                     int var12 = var18 - var9 / 2 + gameAJ(GameCanvas.gameTick - var9 * 3 - (var31 << 2));
                     int var13 = var6 - var9 / 2 + gameAI(GameCanvas.gameTick - var9 * 3 - (var31 << 2));
                     var8.gameAA(var14.gameTN[var10][var31]);
                     var8.gameAC(var12 - var14.gameTO[var31] / 2, var13 - var14.gameTO[var31] / 2, var14.gameTO[var31], var14.gameTO[var31]);
                  }
               }
            }
         } else {
      ...
      if (gameHU) {
         ...
         for (int var4 = 0; var4 < vList.size(); var4++) {
            ...
            if (var2 != null) {
               ...
               mFont.tahoma_7_yellow
                  .gameAA(var1, mResources.gameAU + ": " + var2.id, gameTD + (popupW - 10) / 2 + popupW / 4, gameTE + var4 * gameHK + gameHK / 2 - 10, 2);
   ...
   public static void fieldAC(String var0) {
      ChatPopup.gameAA("[NSO] " + var0, Char.getMyChar());
   }
   ...
   static {
      ...
      if (GameCanvas.isTouch) {
         ...
         imgAT = GameCanvas.gameAC("/hd/at.png");
      ...
      GameCanvas.bgitem6x5 = GameCanvas.gameAC("/bgitem17x5.png");
      GameCanvas.bgitem6x6 = GameCanvas.gameAC("/bgitem17x6.png");
      GameCanvas.bgitem6x7 = GameCanvas.gameAC("/bgitem17x7.png");
      GameCanvas.bgitem6x8 = GameCanvas.gameAC("/bgitem17x8.png");
      ...
      GameCanvas.bgitem7x5 = GameCanvas.gameAC("/bgitem18x5.png");
      GameCanvas.bgitem7x6 = GameCanvas.gameAC("/bgitem18x6.png");
      GameCanvas.bgitem7x7 = GameCanvas.gameAC("/bgitem18x7.png");
      GameCanvas.bgitem7x8 = GameCanvas.gameAC("/bgitem18x8.png");
      ...
      GameCanvas.bgitem8x5 = GameCanvas.gameAC("/bgitem19x5.png");
      GameCanvas.bgitem8x6 = GameCanvas.gameAC("/bgitem19x6.png");
      GameCanvas.bgitem8x7 = GameCanvas.gameAC("/bgitem19x7.png");
      GameCanvas.bgitem8x8 = GameCanvas.gameAC("/bgitem19x8.png");
      ...
      GameCanvas.bgitem9x5 = GameCanvas.gameAC("/bgitem20x5.png");
      GameCanvas.bgitem9x6 = GameCanvas.gameAC("/bgitem20x6.png");
      GameCanvas.bgitem9x7 = GameCanvas.gameAC("/bgitem20x7.png");
      GameCanvas.bgitem9x8 = GameCanvas.gameAC("/bgitem20x8.png");
